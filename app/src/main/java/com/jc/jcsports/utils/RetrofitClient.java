...
public class RetrofitClient {
    ...
    private static com.jc.jcsports.utils.RetrofitService serverInterface;
    ...
    public static com.jc.jcsports.utils.RetrofitService getServerInterface() {
    ...
    private synchronized void init() {
        ...
        if (serverInterface == null) {
            ...
            serverInterface = new Retrofit.Builder()
                    .baseUrl("http://192.168.25.35:8080")
                    ...
                    .build()
                    .create(com.jc.jcsports.utils.RetrofitService.class);
        }
